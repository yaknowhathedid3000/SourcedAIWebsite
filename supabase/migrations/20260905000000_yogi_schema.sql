-- Yogi schema. Mirrors the Swift models in ios/Yogi/Yogi/Models/Models.swift
...
begin
  ...
  if char_length(base_handle) < 3 then base_handle := 'yogi_' || substr(new.id::text, 1, 6); end if;
