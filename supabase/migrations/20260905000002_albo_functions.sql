...
insert into public.checklist_tasks (id, title, subtitle, emoji, reward, target, position) values
  ...
  ('pin',        'Pin the Albo shortcut',    'Import things to Albo even faster.',        '📌', 2,   1, 4),
...
insert into public.stamps (id, title, subtitle, goal_label, target, position) values
  ('hoarder', 'Digital Hoarder', 'Build up your stash in Albo!', 'Import 10 things', 10, 1)
...
-- ---------------------------------------------------------------------------
-- Collections: join by invite token (join.albo.inc/<token>), Albo #77.
-- ---------------------------------------------------------------------------
