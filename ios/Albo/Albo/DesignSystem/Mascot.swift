...
/// The Albo mascot: a black rounded "tooth" with two white eye slits. Vector, scales to any size.
...
/// The Albo wordmark: mascot peeking from the left of a heavy serif "Albo",
...
struct Wordmark: View {
    ...
    var body: some View {
        HStack(alignment: .bottom, spacing: 4) {
            ...
            Text("Albo").font(.system(size: size, weight: .black, design: .serif)).foregroundStyle(AlboColor.ink)
        ...
        .accessibilityLabel("Albo, by The Feel Good Project")
    }
}
