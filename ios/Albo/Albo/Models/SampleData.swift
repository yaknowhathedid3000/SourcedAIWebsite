...
enum SampleData {
    ...
    static let kimmy = UserSummary(name: "Kimmy", handle: "kpdubz", mascot: .chef, countryFlag: "🇺🇸", friendsOnAlbo: 1)
    static let isaac = UserSummary(name: "Isaac", handle: "isaac", mascot: .rocket, countryFlag: "🇬🇧", friendsOnAlbo: 37)
    static let karolina = UserSummary(name: "Karolina @ Albo", handle: "karosaves", mascot: .reader, countryFlag: "🇬🇧", friendsOnAlbo: 14)
    static let jake = UserSummary(name: "Jakee", handle: "jake", mascot: .traveler, countryFlag: "🇬🇧", friendsOnAlbo: 11)
    ...
    static var saves: [Save] {
        [
            Save(id: cookiesID, category: .recipe, title: "Triple Chocolate Cookies", coverEmoji: nil,
            ...
            Save(id: ramenID, category: .recipe, title: "Homemade Shoyu Ramen", coverEmoji: "🍜", coverTint: 0xF7D9B0,
            ...
            Save(id: carbonaraID, category: .recipe, title: "Carbonara", subtitle: "i tuoi piatti da fuorisede", coverEmoji: "🍝", coverTint: 0xDCE8C8,
            ...
            Save(id: potatoSaladID, category: .recipe, title: "Crispy Smashed Potato Salad", coverEmoji: "🥔", coverTint: 0xF3E2C6,
            ...
            Save(id: nycBarID, category: .place, title: "New York City Bar", coverEmoji: "🏛️", coverTint: 0xCFD8DC,
            ...
            Save(id: londonID, category: .place, title: "London", coverEmoji: "🇬🇧", coverTint: 0xD7E3F4,
            ...
            Save(id: hailMaryID, category: .book, title: "Project Hail Mary", subtitle: "Andy Weir", coverEmoji: "🚀", coverTint: 0x1D3557,
            ...
            Save(id: onceUponID, category: .film, title: "Once Upon a Time in Hollywood", coverEmoji: "🎬", coverTint: 0xF4D35E,
            ...
            Save(id: iveEventID, category: .event, title: "IVE - Show What I Am Fan Support by aijoowon", coverEmoji: "🎤", coverTint: 0x2B2D42,
            ...
            Save(id: pullUpID, category: .workout, title: "Pull-Up", coverEmoji: "🏋️", coverTint: 0xE0F2F1,
            ...
            Save(id: lateralRaiseID, category: .workout, title: "Lateral Raise", coverEmoji: "💪", coverTint: 0xE8EAF6,
            ...
            Save(id: stAlbansID, category: .article, title: "10 of the Best Things to do in St Albans", subtitle: "emilyluxton.co.uk", coverEmoji: "🌳", coverTint: 0xCDE7C4,
            ...
            Save(id: cookieNoteID, category: .note, title: "Cookie recipes", coverEmoji: nil, coverTint: 0xF4F4F4,
                 sourcePlatform: .note, status: .saved, saveCount: 1, createdAt: date(2026, 6, 10, 9),
                 noteBody: "- ## **Triple Chocolate Cookies** *italic*", savedBy: [me]),

            Save(id: kohCafeID, category: .place, title: "KOH Cafe + Roasters", coverEmoji: "☕️", coverTint: 0xE6D5C3,
            ...
            Save(id: deliID, category: .place, title: "717 DELI", coverEmoji: "🥪", coverTint: 0xF9E4B7,
    ...
    static var checklist: [ChecklistTask] {
        [
            ...
            ChecklistTask(id: "pin", title: "Pin the Albo shortcut", subtitle: "Import things to Albo even faster.", emoji: "📌", reward: 2),
